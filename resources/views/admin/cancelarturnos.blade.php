    ...
    <div class="col-8 col-sm-6 col-md-6 mx-auto">
        <div class="card text-black mb-3" style="max-width: 100rem;">
            <div class="card-body text-Black text-center">
              <h4 class="card-title">Cancelar turnos</h4>
            </div>                  
        </div>
    </div>
    <div class="form-group">
        <div class="my-2 pb-1 barrapaso-cancelar" id="barra1"></div>    
    </div>
    <article class="container col-12 mx-auto p-0">
        <div class="col-11 col-sm-11 col-md-4 col-lg-4 d-flex flex-column mx-auto p-0 my-4">
            <form id="demoForm" method="post" action="{{ url('admin/cancelarturnospost')  }}" data-toggle="validator" role="form">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    {{-- <input type="date" id="myDate" name="bday" min="1980-01-01" max="2000-01-01" class="form-control"> --}}
                </div>
                <div class="form-group">
            ...
            <label>&nbsp;</label>
                ...
                <div class="form-group d-flex justify-content-center">
                    <input type="submit" class='btn btn-danger btn-lg' value="Cancelar Turnos">
                </div>
            </form>
        </div>	
    </article>
