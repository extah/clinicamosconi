    ...
    <section class="mx-0 px-0">
        ...
        <article class="container col-12 mx-auto p-0">
                    <div class="col-11 col-sm-11 col-md-10 col-lg-8 d-flex flex-column mx-auto p-0 my-4">
                       ...
                       <p class="lh-base d-flex mx-auto">Con el horizonte puesto en recuperar la calidad de las prestaciones, se reactivó el servicio de guardia pediátrica y, como hito para la región, se avanza en la conformación de una Guardia Web que permitirá asistir por videollamada consultas médicas desde cualquier lugar del mundo, lo que nos posicionará a la vanguardia de los centros de salud de la zona.</p>
