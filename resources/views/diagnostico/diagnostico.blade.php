                    ...
                    <img class="container img-fluid mx-auto px-auto mt-2 pt-lg-1" src="{{ asset('images/iconos/horarios.png')}}" alt="Horarios">
                                    <div class="container d-flex flex-column justify-content-center mt-3 pt-1">
                                        <div class="px-1 d-flex flex-column">
                                            <p class="col-12 d-inline text-center text-sm-center text-md-center text-lg-start px-auto px-sm-auto px-md-auto px-lg-3 mx-1">Lunes a Viernes de 08 a 18 horas</p>                                
                                        </div>
                                        <div class="px-1 d-flex flex-column">
                                            <p class="col-12 d-inline text-center text-sm-center text-md-center text-lg-start px-auto px-sm-auto px-md-auto px-lg-3 mx-1"><span class="fw-bolder">Guardias pasivas: </span>lunes a viernes de 20 a 08 horas y sábados, domingos y feriados.</p>
                                        </div>
                                    </div>
                </div>
        
                <div class="col-10 col-sm-10 col-md-6 col-lg-4 px-lg-2 mx-auto mx-sm-auto mx-md-auto mx-lg-2">
                    <img class="container img-fluid mx-auto px-auto" src="{{ asset('images/iconos/telefono-diagnostico-por-imagenes.png')}}" alt="Teléfono">
                </div>
